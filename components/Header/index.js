...
import { DeviceCheck } from '../../resources/utils';
                ...
                <div className={styles.navWrapper}>
                    {
                        routes.map(item => {
                            ...
                            return (
                                <Link 
                                    key={item.name} 
                                    className={currentRoute === routePath ? `${styles.nav__link} nav__link-active` : styles.nav__link}
                                    href={routePath}
                                >
                                    {item.name}
                                </Link>
...
const HamburguerMenuIcon = ({ setIsModalOpen }) => (
    <div className="hamburguer-menu" onClick={() => setIsModalOpen(true)}>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
            <path d="M3.75 22.5V20.625H26.25V22.5H3.75ZM3.75 15.9375V14.0625H26.25V15.9375H3.75ZM3.75 9.375V7.5H26.25V9.375H3.75Z" fill="black"/>
        </svg>
    </div>
)

const Menu = ({ routes, currentRoute, setIsModalOpen }) => (
    <section id="menu" className={styles.menuLayer} onClick={(evt)=> {
