const categoriesObjects = {
    Chromebooks: {
        name: 'Chromebooks', url: '/chromebooks',
    },
    GoogleChrome: {
        name: 'Google Chrome', url: '/chrome-browser',
    },
    Gaming: {
        name: 'Jogos', url: '/gaming',
    },
    ChromeOS: {
        name: 'ChromeOS', url: '/chrome-os',
    },
    Programming: {
        name: 'Programação', url: '/programming',
    },
};
...
export const DeviceCheck = () => {
    ...
    return {
        ...
        isTablet: windowScreenDetector && window.innerWidth >= 768 && window.innerWidth <= 1024,
